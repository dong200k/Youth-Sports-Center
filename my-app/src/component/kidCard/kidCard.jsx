  ...
  constructor(props){
    ...
    this.state = {
      ...
      kid:{
        ...
        contacts:[9293001823,],
        medical_issues: this.props.medical_issues,
        programs:[],
      },
      edit:{
