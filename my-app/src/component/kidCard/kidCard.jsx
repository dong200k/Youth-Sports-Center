  ...
  render() {
    return (
      <div className="kidCard">
        <div className={`kidInfo ${this.state.isEdit? "hidden": ""}`}>
          <button className="kidEditbtn"
            onClick={() => {
              this.setState({
          ...
          <div className="leftContainer">
            <div className="content">
              ...
              <span className="contentSpan">{this.state.kid.name}</span>
            </div>
            <div className="content">
              <label className="contentLabel">Gender</label> <span className="contentSpan">{this.state.kid.gender}</span>
            </div>
            <div className="content">
              <label className="contentLabel">Birthday</label> <span className="contentSpan">{this.state.kid.birthday}</span>
            </div>
          </div>

          <div className="kidAvatar">
            <img
              src={this.state.kid.picture}
              className="kidImg"
              alt=""
            />
          </div>
          ...
          <div className="rightContainer">
            ...
            {Object.keys(this.state.kid.medical_issues).map(type => (
                <div className="content" key={type}>
                  <label className="contentLabel">{type}:</label> 
                  <span className="contentSpan">
                    {this.state.kid.medical_issues[type].map(item => (
                    <span key={item}>{item + "\xa0"}</span>
                    ))}
                  </span>
                </div>
            ))}
        ...
        <div className={`kidEdit ${this.state.isEdit? "": "hidden"}`}>
          <button className="kidEditbtn"
          onClick={() => {
            this.setState({
              isEdit: !this.state.isEdit
